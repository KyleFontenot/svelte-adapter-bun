...
export default function ({ out, precompress, envPrefix, development, dynamic_origin, xff_depth, assets, websockets, } = {
    out: "build",
    precompress: false,
    envPrefix: "",
    development: false,
    ...
    return {
        ...
        async adapt(builder) {
            ...
            const insertFnToAggregator = (method) => method in hooksHandler ? `${hooksHandler[method].toString()},\n` : "";
